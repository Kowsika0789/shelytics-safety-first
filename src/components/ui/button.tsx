  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        // SHElytics custom variants
        hero: "bg-gradient-to-r from-primary to-[hsl(320,70%,50%)] text-primary-foreground hover:opacity-90 shadow-medium",
        safe: "bg-safe text-primary-foreground hover:bg-safe/90 shadow-safe",
        risk: "bg-risk text-primary-foreground hover:bg-risk/90",
        emergency: "bg-emergency text-primary-foreground hover:bg-emergency/90 shadow-sos",
        glass: "bg-background/20 backdrop-blur-xl border border-border/30 text-primary-foreground hover:bg-background/30",
      },
      size: {
